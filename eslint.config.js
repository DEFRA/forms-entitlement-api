...
export default [
  ...
  // Base neostandard config (includes n, promise, import-x plugins)
  ...
  // JSDoc recommended for TS base
  jsdocPlugin.configs['flat/recommended'],

  // Disable type-checked rules and other strict rules for .d.ts files
  {
    files: ['**/*.d.ts'],
    rules: {
  ...
  // JS-specific override with JSDoc recommended-typescript-flavor
  // Applied before custom rules so custom rules take precedence
  {
    files: ['**/*.{cjs,js,mjs}'],
